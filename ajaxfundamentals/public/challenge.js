$(document).ready(function(){
	...
	if(!localStorage.getItem('planets')){
		$.ajax({
			...
			localStorage.setItem('planets', JSON.stringify(planetsObj)) //json stringify makes object a string for localStorage, which uses strings
		})  // setItem adds an item, requires two inputs, name and what
	}
	...
	$(wookie).on('click',function(){
		...
		if(clicker){
			...
			let wookieObj = JSON.parse(localStorage.getItem('wookies')); //json.parse takes the string and turns it back into an object
